        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumQuantity = table.Column<decimal>(type: "decimal(65,30)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "varchar(10)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalQuantity = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BranchTransactions_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BranchTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchTransactions_BranchId",
                table: "BranchTransactions",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_BranchTransactions_TransactionId",
                table: "BranchTransactions",
